...
# Group Logo on Left
try:
    logo = Image.open("logo.png")  # Replace with actual logo file
...
team_label = tk.Label(top_frame, text="Dataset:\nFruit-360", 
                      font=("Arial", 12), justify="left")
team_label.grid(row=0, column=1, sticky="w")

# Add Project Title
title_label = tk.Label(root, text="Fruit Recognition", font=("Arial", 18, "bold"))
